...
$site_top = "https://climatetech.co.jp/chemsherpa/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "yusa.yoshida@climatetech.co.jp, motoharu.shirai@climatetech.co.jp";
...
$from = "motoharu.shirai@climatetech.co.jp";
...
$thanksPage = "https://climatetech.co.jp/chemsherpa/thanks";
...
$require = array('姓','名','メールアドレス','メールアドレス確認','ご相談内容','同意する');
